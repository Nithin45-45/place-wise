    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 bg-gradient-to-b from-slate-900 via-blue-900 to-slate-800">
        ...
        <div className="absolute top-8 right-8 md:top-12 md:right-16">
          <Image src="https://static.wixstatic.com/media/52cebc_ff17950f8c494f8c9e6d08fc2b8cb492~mv2.png?originWidth=128&originHeight=128" alt="Beautiful AI-generated moon in the night sky" className="w-24 h-24 md:w-32 md:h-32 opacity-90 drop-shadow-2xl" />
        </div>
